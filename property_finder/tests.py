...
class ViewsTests(TestCase):
    ...
    def test_listing_view(self):
        ...
        response = self.client.get(
            reverse('property_details', args=[listing.slug]))
        self.assertEqual(200, response.status_code)

    def test_map_view(self):
        response = self.client.get(
            reverse('listings-map'), HTTP_X_REQUESTED_WITH='XMLHttpRequest')
        self.assertEqual(200, response.status_code)
...
class UtilsTests(TestCase):
    ...
    def test_import_validator(self):
        ...
        self.assertRaises(
            ImportError, lambda: import_validator('fake.validator'))
...
class ModelTests(TestCase):
    ...
    def test_location(self):
        ...
        self.assertIn(self.listing.location.name, self.listing.location.get_parent_name(
