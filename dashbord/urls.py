...
urlpatterns = patterns(
    url('^listing/', admin_views.Listings.as_view(),
    ...
    url('^update-agent/(?P<pk>\d+)$',
        admin_views.UpdateAgent.as_view(), name='update-agent'),
    url('^contacts/', admin_views.Contacts.as_view(),
        name='admin-list-contacts'),
    url('^new-contact/', admin_views.CreateContact.as_view(),
        name='add-contact'),
    url('^update-contact/(?P<pk>\d+)$',
        admin_views.UpdateContact.as_view(), name='update-contact'),
    url('^locations/', admin_views.Locations.as_view(),
        name='admin-list-sectors'),
    url('^new-location/', admin_views.CreateLocation.as_view(),
        name='add-sector'),
    url('^update-location/(?P<pk>\d+)$',
    ...
    url('^update-user/(?P<pk>\d+)$',
        admin_views.UpdateUser.as_view(), name='update-user'),
    url('^set-user-password/(?P<user_id>\d+)$',
